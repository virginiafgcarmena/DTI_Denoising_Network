...
function [trained_ynet_STEAM,info] = train_ynet_STEAM(dataset,perc,ntest)
...
input_weights_SE = 'UNETSE_RETGA_E30_MB15_LR01_DF98-1_SD_MO98_SSIM9MAE1_nores'; %If not blank, path to the U-network that must be loaded to copy its weights
%input_weights_SE = '';
