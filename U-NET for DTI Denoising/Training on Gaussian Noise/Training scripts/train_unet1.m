function [trained_unet1,info,options] = train_unet1(dataset,perc,ntest)
%Global parameters
img_size = [120 88];
...
size_minibatch_validation = round(length(VA_NO_DS.Files));
...
options = trainingOptions('sgdm',...
    ...
    'ValidationFrequency',(round(training_datastore.NumObservations)),...
    'Momentum',0.97);
 
    %'Verbose',false,...
%4 Training

[trained_unet1,info] = trainNetwork(training_datastore,lgraph,options);
